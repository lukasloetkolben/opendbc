...
class CarState(CarStateBase):
  ...
  def update(self, cp, cp_cam, cp_adas, *_) -> structs.CarState:
    ...
    # Cruise state
    cruise_state = self.can_define.dv["DI_state"]["DI_cruiseState"].get(int(cp.vl["DI_state"]["DI_cruiseState"]))
    speed_units = self.can_define.dv["DI_state"]["DI_speedUnits"].get(int(cp.vl["DI_state"]["DI_speedUnits"]))
